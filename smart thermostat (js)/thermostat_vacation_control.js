...
var FORECAST_RESOURCE = "coap://localhost:5685/apps/running/forecast_simulation/tomorrow/low_temperature"; // "coap://localhost:5685/apps/running/weather/tomorrow/low_temperature";
var TEMPERATURE_RESOURCE = "coap://localhost:5685/apps/running/forecast_simulation/now/temperature"; // "coap://localhost:5685/apps/running/weather/now/temperature";
...
function start() {
	...
	var control_payload = "resid = " + APP_NAME + "\n" + 
						  ...
						  "target = " + MULTICAST + "/" + APP_NAME + "/cast" + "\n" +
						  "targetoperation = PUT" + "\n" +
